    ...
    for idx2, ltr in enumerate(line):
      if ltr == 'X':
        ...
        if idx2 <= 136:
          ...
          if wordsearch[idx1][idx2+1] == 'M':
            if wordsearch[idx1][idx2+2] == 'A':
              if wordsearch[idx1][idx2+3] == 'S':
                count += 1
          # Check the diagonal for 'XMAS' going to the top-right
          if idx1 >= 3:
            if wordsearch[idx1-1][idx2+1] == 'M':
              if wordsearch[idx1-2][idx2+2] == 'A':
                if wordsearch[idx1-3][idx2+3] == 'S':
                  count += 1
      ...
      if idx1 <= 136:
        ...
        if wordsearch[idx1+1][idx2] == 'M':
          if wordsearch[idx1+2][idx2] == 'A':
            if wordsearch[idx1+3][idx2] == 'S':
              count += 1
      if idx1 >= 3:
